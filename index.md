...
venue: "Universiteit Leiden, Universiteit van Amsterdam, & Vrije Universiteit"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
